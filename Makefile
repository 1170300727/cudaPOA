...
$(SRC_DIR)/abpoa.o:$(SRC_DIR)/abpoa.cu $(SRC_DIR)/abpoa.h $(SRC_DIR)/abpoa_graph.h $(SRC_DIR)/abpoa_align.h \
                   $(SRC_DIR)/seq.h $(SRC_DIR)/utils.h $(SRC_DIR)/simd_instruction.h $(SRC_DIR)/helper_cuda.h $(SRC_DIR)/helper_string.h
	$(EXEC) $(NVCC) $(INCLUDES) $(ALL_CCFLAGS) $(GENCODE_FLAGS) $(SIMD_FLAG) -o $@ -c $<

$(SRC_DIR)/simd_check.o:$(SRC_DIR)/simd_check.c $(SRC_DIR)/simd_instruction.h
	$(EXEC) $(NVCC) $(INCLUDES) $(ALL_CCFLAGS) $(GENCODE_FLAGS) -o $@ -c $<

$(SRC_DIR)/simd_abpoa_align.o:$(SRC_DIR)/simd_abpoa_align.cu $(SRC_DIR)/abpoa_graph.h $(SRC_DIR)/abpoa_align.h \
	$(SRC_DIR)/simd_instruction.h $(SRC_DIR)/utils.h $(SRC_DIR)/helper_cuda.h $(SRC_DIR)/helper_string.h
	$(EXEC) $(NVCC) $(INCLUDES) $(ALL_CCFLAGS) $(GENCODE_FLAGS) -o $@ -c $<

$(SRC_DIR)/utils.o:$(SRC_DIR)/utils.c
	$(EXEC) $(NVCC) $(INCLUDES) $(ALL_CCFLAGS) $(GENCODE_FLAGS) -o $@ -c $<

$(SRC_DIR)/abpoa_align.o:$(SRC_DIR)/abpoa_align.c $(SRC_DIR)/abpoa.h
	$(EXEC) $(NVCC) $(INCLUDES) $(ALL_CCFLAGS) $(GENCODE_FLAGS) -o $@ -c $<

$(SRC_DIR)/abpoa_graph.o:$(SRC_DIR)/abpoa_graph.c
	$(EXEC) $(NVCC) $(INCLUDES) $(ALL_CCFLAGS) $(GENCODE_FLAGS) -o $@ -c $<

$(SRC_DIR)/abpoa_plot.o:$(SRC_DIR)/abpoa_plot.c
	$(EXEC) $(NVCC) $(INCLUDES) $(ALL_CCFLAGS) $(GENCODE_FLAGS) -o $@ -c $<
